// textcommands/setnote.js
// Usage: ,setnote @user <amount> [event] [note...]
...
module.exports = {
    ...
    async execute(message, args) {
        ...
        if (!targetUser) {
            return message.reply('Please mention a user. Usage: `,setnote @user <amount> [event] [note...]`');
        }
        ...
        if (!amountRaw) {
            return message.reply('Please provide an amount. Usage: `,setnote @user <amount> [event] [note...]`');
        }
