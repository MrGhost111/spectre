...
const ROLE_CONFIGS = {
    ...
    tier2: {
        roles: ['866641249452556309', '768449168297033769', '1028256279124250624'],
        luck: 70
    },
    tier3: {
...
const BOOSTER_ROLES = ['713452411720827013', '721331975847411754', '721020858818232343'];
            ...
            if (targetMember) {
                ...
                setTimeout(async () => {
                    ...
                    const userMute = latestMutes.users.find(mute => 
                        mute.userId === muteUser && mute.muteEndTime === muteEndTime
                    );
