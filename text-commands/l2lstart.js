    ...
    async execute(message, args) {
        ...
        try {
            ...
            const statusEmbed = new EmbedBuilder()
                ...
                .setTimestamp()
                .addFields(
                    { name: 'Event Duration', value: '0s', inline: true },
                    { name: 'Participants Remaining', value: `${currentParticipants.size}/${Object.keys(eventData.participants).length}`, inline: true }
                );
            ...
            statusEmbed.addFields({ name: 'Participants Status', value: participantsList });
