const settings = require('../functions/wos/Settings/settings');
const language = require('../functions/wos/Settings/language');
const autoClean = require('../functions/wos/Settings/autoClean');
const autoUpdate = require('../functions/wos/Settings/autoUpdate');
const db = require('../functions/wos/Settings/backup/backup');
...
const backUpView = require('../functions/wos/Settings/backup/backupView');
const backupRestore = require('../functions/wos/Settings/backup/backupRestore');
const backupReAuth = require('../functions/wos/Settings/backup/backup_reauth');
const emojis = require('../functions/wos/Settings/theme/emojis');
...
const emojisReload = require('../functions/wos/Settings/theme/emojisReload');
const emojisTemplate = require('../functions/wos/Settings/theme/emojisTemplate');
const pluginsMain = require('../functions/wos/Plugin/plugins');
const pluginInstall = require('../functions/wos/Plugin/pluginInstall');
const pluginDelete = require('../functions/wos/Plugin/pluginDelete');
const pluginAccess = require('../functions/wos/Plugin/pluginAccess');
const panel = require('../functions/wos/Panel/backToPanel');
const alliance = require('../functions/wos/Alliance/Alliance');
const players = require('../functions/wos/Players/players');
const support = require('../functions/wos/Support/support');
const report = require('../functions/wos/Support/report');
const { processRecovery } = require('../functions/wos/Processes/processRecovery');

const addPlayer = require('../functions/wos/Players/addPlayer');
const fetchPlayerData = require('../functions/wos/Players/fetchPlayerData');
...
const giftCode = require('../functions/wos/GiftCode/giftCode');
...
const notification = require('../functions/wos/Notification/notification');
...
const templateLibrary = require('../functions/wos/Notification/templateLibrary');
...
const calculators = require('../functions/wos/Calculators/calculators');
