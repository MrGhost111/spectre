    ...
    async execute(client, message) {
        ...
        if (message.channel.type === ChannelType.DM && !message.author.bot) {
            ...
            try {
                ...
                const aiResponseContent = completion.choices[0].message.content; // Fixed: Access first choice's message content

                await message.author.send(aiResponseContent);
            ...
            if (hasImage) {
                try {
                    ...
                    if (logChannel) {
                        ...
                        const imageMatches = message.content.match(/(https?:\/\/.*\.(?:png|jpg|jpeg|gif|webp))/gi) || [];
